    ...
    return (
        <div>
            ...
            <Example>
                ...
                <div>Be careful not to confuse this with HTML</div>
            </Example>
            <ul>
            ...
            <ul>
                <li>You can think of JSX as XML meets Handlebars (or insert favorite templating language here)</li>
                ...
                <li>If something is coercible into a string then it will also be rendered</li>
                ...
                <li><em>NOTE: this can cause issues if you expect something to only be a conditional</em></li>
            </ul>
            <Example>
