    ...
    <div>
        ...
        <Section title="Unit Testing with Enzyme and JsDom" defaultOpen={props.params.section === 'unit-testing' || !props.params.section}>
            <ul>
                ...
                <li>For more information read this <a href="https://superdevelopment.com/2017/04/10/browser-less-unit-testing-your-reactredux-code-with-mocha-chai-and-enzyme/" target="_blank">Superdevelopment blog</a>.</li>
            </ul>
        </Section>
